...
<head>
    ...
    <title>Administración - Inicio de Sesión</title>
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            @if (Route::has('password.request'))
                                                <a href="{{ route('password.request') }}"><small>Olvidaste Contraseña?</small></a>
                                            @endif
                                        </div>
                                ...
                                <p class="text-center mt-2"><span>New on our platform?</span>
                                    <a href="page-auth-register-v2.html"><span>&nbsp;Crear Cuenta</span></a></p>
