                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Ver Moneda
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Ver Moneda</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input id="name" type="text" name="acronym" class="form-control" value="{{ $data->acronym }}" readonly/>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-3 col-form-label">
                                                ...
                                                <div class="col-sm-9">
                                                    <input id="name" type="text" name="symbol" class="form-control" value="{{ $data->symbol }}" readonly/>
                                                </div>
                                            </div>
                                        </div>
