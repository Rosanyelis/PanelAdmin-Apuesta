                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <a href="{{ url('/roles/crear-rol') }}" class="btn btn-primary "><i data-feather='plus'></i> Nuevo Rol</a>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($roles as $item)
                                            <tr>
                                                ...
                                                <td class="p-0">
                                                    <a href="{{ url('/roles/'.$item->id.'/ver-rol') }}" class="btn btn-icon btn-icon rounded-circle btn-flat-primary waves-effect"><i data-feather='eye'></i></a>
                                                    <a href="{{ url('/roles/'.$item->id.'/editar-rol') }}" class="btn btn-icon btn-icon rounded-circle btn-flat-warning waves-effect"><i data-feather='edit-2'></i></a>
                                                    ...
                                                    <div class="modal fade text-left modal-warning" id="delete-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel140" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <form method="POST" action="{{ url('/roles/'.$item->id.'/eliminar-rol') }}">
                                                                    @csrf
                                                                    @method('DELETE')
